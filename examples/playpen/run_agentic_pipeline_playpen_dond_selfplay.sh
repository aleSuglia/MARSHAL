...
ROLL_OUTPUT_DIR="./runs/playpen_dond_selfplay/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_val_playpen_dond_selfplay | tee $ROLL_LOG_DIR/custom_logs.log
