...
ROLL_OUTPUT_DIR="./runs/playpen_clean_up_selfplay/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_val_playpen_clean_up_selfplay | tee $ROLL_LOG_DIR/custom_logs.log
